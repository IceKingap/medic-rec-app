[README.md](https://github.com/user-attachments/files/28166439/README.md)
# 薬服用記録 (MedicRec)
...
6. 飲み忘れ通知 (1日の回数ベース) が来たら、通知の「飲んだ」ボタンでアプリを開かずに記録可能
...
- スキーマ v1 → v2 で `medications` テーブルに `notes` カラムを追加 (Migration_1_2)
